...
\begin{document}
    ...
    \begin{exm}{Non-Functions}{}
        The following pictures \emph{do not} define functions.
        Can you see why?
        \begin{equation}
    ...
    \begin{remark}{}{}
        ...
        \begin{lstlisting}[gobble=12, language=python, basicstyle=\color{black!85}\ttfamily]
            def length(l: list) -> int:
               ...
               # which returns the length
                return len(l)
        \end{lstlisting}
        This defines a function, \lstinline[language=python, basicstyle=\color{black!85}\ttfamily]|length|, from the set of all lists to \(\integers_{\ge 0}\).
        ...
        \begin{lstlisting}[gobble=12, language=python, basicstyle=\color{black!85}\ttfamily]
            ...
            def length(l: list) ->:
                ...
                # exitthe value of x out of the scope
                global x
                x = 4
                return len(l)
        \end{lstlisting}
    ...
    The terminology \enquote{injective} is preferred by mathematicians, but the term one-to-one is still common, particularly informally.
